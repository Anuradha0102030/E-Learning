 <!-- Start Footer -->
 <footer class="container-fluid text-center p-2" style="background-color:rgb(34, 84, 112)" >
    ...
    <div class="modal fade" id="stuRegModalCenter" tabindex="-1" role="dialog" aria-labelledby="stuRegModalCenterTitle" aria-hidden="true" >
      <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content" style="background-color:rgb(34, 84, 112);color:#fff;border-radius:25px;border:1px solid #123254;">
          <div class="modal-header">
            <h5 class="modal-title" id="stuRegModalCenterTitle" style="font-size:1.8em;">Student Registration</h5>
